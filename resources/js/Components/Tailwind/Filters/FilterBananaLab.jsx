...
const FilterBananaLab = ({ items, data, filteredData, cart, setCart,setFavorites,favorites }) => {
    ...
    const fetchProducts = async (page = 1, shouldScroll = false) => {
        ...
        try {
            ...
            console.log('✅ DEBUG - Brands state set:', response?.summary.brands || []);
            console.log('✅ DEBUG - Categories state set:', response?.summary.categories || []);
            console.log('✅ DEBUG - Collections state set:', response?.summary.collections || []);
            console.log('✅ DEBUG - Price ranges state set:', response?.summary.priceRanges || []);
   ...
   const sortOptions = [
    ...
    // Filtrar categorías según el input, mostrar todas aunque no tengan subcategorías
