...
import ProductCardColorsBoton from "../Products/Components/ProductCardColorsBoton";
...
const modernFilterStyles = {
    ...
    searchInput: "form-checkbox text-red-600 w-full pl-12 pr-4 py-5 bg-white/90 backdrop-blur-sm border border-gray-200/60 rounded-xl focus:ring-2 focus:ring-blue-500/30 focus:border-blue-400 transition-all duration-300 placeholder:customtext-neutral-dark",
    checkbox: "form-checkbox appearance-none min-h-5 min-w-5 rounded-md border-2 border-gray-300 text-[#FF7F00] focus:ring-0 focus:ring-transparent focus:outline-none transition-all duration-200 hover:border-[#FF7F00]",
...
const CatalagoFiltrosPaani = ({ items, data, filteredData, cart, setCart }) => {
    ...
    const currentCategorySlug = GET.category;
    ...
    return (
        <section className=" bg-gradient-to-br from-gray-50/50 via-white to-blue-50/30 font-title">
            ...
            {/* {currentCategory?.banner && (
                    ...
                    >
                        <img 
                            src={`/storage/images/category/${currentCategory.banner}`}
                                            ...
                                            <AnimatePresence>
                                                ...
                                                (selectedFilters.price && selectedFilters.price.length > 0)) && (
                                                    <motion.div
                                                        ...
                                                        exit={{ opacity: 0, y: -10 }}
                                                    >
                                                        <h4 className="text-sm 2xl:text-base font-semibold customtext-neutral-dark mb-3 flex items-center gap-2">
                                                        ...
                                                        <div className="flex flex-wrap gap-2">
                                                            ...
                                                            {selectedFilters.brand_id?.map((brandSlug) => {
                                                                ...
                                                                return brand ? (
                                                                    ...
                                                                    >
                                                                        <Tag className="h-3 w-3 customtext-neutral-light" />
                                                                        <span className="customtext-neutral-light 2xl:text-lg">{brand.name}</span>
                                                                        <motion.div
                                                                            className="ml-1  rounded-full p-0.5 transition-colors duration-200"
                                                                            whileHover={{ scale: 1.2 }}
                                                                            whileTap={{ scale: 0.9 }}
                                                                        >
                                                                            <X className="h-3 w-3 customtext-neutral-light" />
                                                                        </motion.div>
                                                                    </AnimatedBadge>
                                                                ) : null;
                                                            })}
                                                            ...
                                                            {selectedFilters.category_id?.map((categorySlug) => {
                                                                ...
                                                                return category ? (
                                                                    <AnimatedBadge
                                                                        ...
                                                                        className="bg-accent"
                                                                    >
                                                                        <Layers className="h-3 w-3 2xl:h-5 2xl:w-5 customtext-neutral-light" />
                                                                        <span className="customtext-neutral-light 2xl:text-lg">{category.name}</span>
                                                                        <motion.div
                                                                            className="ml-1  rounded-full p-0.5 transition-colors duration-200"
                                                                            whileHover={{ scale: 1.2 }}
                                                                            whileTap={{ scale: 0.9 }}
                                                            ...
                                                            {selectedFilters.subcategory_id?.map((subcategorySlug) => {
                                                                ...
                                                                return subcategory ? (
                                                                    <AnimatedBadge
                                                                        ...
                                                                        className="bg-accent"
                                                                    >
                                                                        <Grid3X3 className="h-3 w-3 2xl:h-5 2xl:w-5 customtext-neutral-light" />
                                                                        <span className="customtext-neutral-light 2xl:text-lg">{subcategory.name}</span>
                                                                        <motion.div
                                                                            className="ml-1 rounded-full p-0.5 transition-colors duration-200"
                                                                            whileHover={{ scale: 1.2 }}
                                                                            whileTap={{ scale: 0.9 }}
                    ...
                    >
                        ...
                        <AnimatePresence mode="wait">
                            {loading ? (
                                ...
                                <motion.div
                                    className="grid grid-cols-2 xl:grid-cols-3 gap-4 md:gap-y-3 md:gap-x-6 w-full   transition-all duration-300 ease-in-out"
                                    key="products"
                                    initial={{ opacity: 0 }}
                                    animate={{ opacity: 1 }}
                                    exit={{ opacity: 0 }}
                                >
                                    {Array.isArray(products) && products.length > 0 ? (
                                        ...
                                        <motion.div
                                            className="col-span-2 xl:col-span-3 w-full flex items-center justify-center py-16"
...
export default CatalagoFiltrosPaani;
