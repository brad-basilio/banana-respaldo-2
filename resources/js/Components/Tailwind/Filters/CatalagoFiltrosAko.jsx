                    ...
                    >
                        ...
                        <AnimatePresence mode="wait">
                            {loading ? (
                                ...
                                <motion.div
                                    className="grid grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6 w-full gap-y-4 md:gap-y-8 transition-all duration-300 ease-in-out"
                                    key="products"
                                    initial={{ opacity: 0 }}
                                    animate={{ opacity: 1 }}
                                    exit={{ opacity: 0 }}
                                >
                                    {Array.isArray(products) && products.length > 0 ? (
                                        products.map((product, index) => (
                                            <motion.div
                                                className="w-full lg:h-[460px] lg:max-h-[500px] xl:h-[450px] xl:max-h-[450px] 2xl:h-[450px] 2xl:max-h-[450px] flex items-center justify-center"
                                                key={product.id}
