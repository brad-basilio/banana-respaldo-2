                        ...
                        {tags.map((tag, index) => (
                            <li key={tag.id} className="">
                                <a
                                    ...
                                    className={
                                        "font-medium bg-primary text-white rounded-full p-2 hover:customtext-primary cursor-pointer transition-all duration-300  relative flex items-center gap-2"
                                    }
