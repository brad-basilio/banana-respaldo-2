    ...
    return (
        <nav
            className={
                `${
                showOnlyTagsMobile
                        ? " block w-full relative md:block bg-[#F93232] font-paragraph text-sm"
                                    ...
                                    {tags.map((tag, index) => (
                                        <li key={tag.id} className="">
                                            <a
                                                href={`/catalogo?tag=${tag.id}`}
                                                className={
                                                    "font-medium bg-[#F93232] text-white rounded-full p-2 hover:brightness-105 cursor-pointer transition-all duration-300  relative flex items-center gap-2"
                                                }
                                                title={tag.description || tag.name}
                                            >
                                                <Tag size={16} className="text-white" />
