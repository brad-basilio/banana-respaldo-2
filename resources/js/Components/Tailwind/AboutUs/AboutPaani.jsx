            ...
            >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 xl:gap-10 font-title">
                    ...
                    <div className="flex flex-col gap-3 justify-around 2xl:gap-10 2xl:justify-center">
                        <div className="flex flex-col gap-4 items-start min-w-[240px] bg-[#F2F2F2] group hover:bg-[linear-gradient(90deg,_#003D52_0%,_#0075A7_118.41%)] rounded-xl p-6">
                            <div className="rounded-full w-14 h-14 flex flex-row justify-center items-center">
                                <div className='bg-[linear-gradient(90deg,_#003D52_0%,_#0075A7_118.41%)] rounded-xl overflow-hidden'>
                                    <img
            ...
            >
                <div className="">
                    <motion.div variants={fadeInUp} className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                        <img
                            src={`/storage/images/aboutus/${titleMision?.image}`}
                            onError={(e) => (e.target.src = "/api/cover/thumbnail/null")}
                            alt={titleMision?.title}
            ...
            >
                <div className="">
                    <motion.div variants={fadeInUp} className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                        ...
                        <img
                            src={`/storage/images/aboutus/${titleVision?.image}`}
                            onError={(e) => (e.target.src = "/api/cover/thumbnail/null")}
                            alt={titleVision?.title}
                            className="w-full h-[300px] md:h-auto object-cover rounded-2xl"
                        />
                    </motion.div>
                </div>
