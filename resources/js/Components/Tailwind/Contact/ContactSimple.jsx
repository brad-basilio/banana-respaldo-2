        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex justify-start items-start gap-3 aos-init aos-animate" data-aos="fade-up" data-aos-offset="150">
              <div className="w-6">
              <svg className="stroke-neutral-light stroke-[0.5]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M4.125 6.125L12 11.1875L20.4375 6.125M5.25 18.3044C4.00736 18.3044 3 17.297 3 16.0544V7.25C3 6.00736 4.00736 5 5.25 5H18.75C19.9926 5 21 6.00736 21 7.25V16.0543C21 17.297 19.9926 18.3044 18.75 18.3044H5.25Z" stroke="#91502D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
              </div>
              <div className="flex flex-col gap-2">
