    ...
    */
    ...
    'connections' => [
        ...
        'mysql_atalaya' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_ATALAYA', '127.0.0.1'),
            'port' => env('DB_PORT_ATALAYA', '3306'),
            'database' => env('DB_DATABASE_ATALAYA', 'forge'),
            'username' => env('DB_USERNAME_ATALAYA', 'forge'),
            'password' => env('DB_PASSWORD_ATALAYA', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
